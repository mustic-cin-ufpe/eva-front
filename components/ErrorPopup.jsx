...
const PopupBackground = styled.div`
  ...
  padding: 10px;
  position: absolute;
  top: ${(props) => props.height - heightOffset + "px"};
  left: 50%;
  transform: translate(-50%, 0);
  animation: showError ${animationCycle} ease-in-out;
  opacity: 0;
  z-index: -1;
...
const Title = styled.h1`
  ...
  text-align: center;
  margin-bottom: 0;
  animation: showErrorTitle ${animationCycle} ease-in-out;
...
const Description = styled.p`
  ...
  animation: showErrorDescription ${animationCycle} ease-in-out;
